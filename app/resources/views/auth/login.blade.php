            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end rounded-pill">{{ __('教習生番号') }}</label>
                        ...
                        <div class="row mb-0 mt-5">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-blue btn-info mx-auto d-block w-100">
                                    {{ __('ログイン') }}
                                </button>
                            </div>
                        </div>
